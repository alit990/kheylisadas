...
function sendAudioComment(audioId) {
    var comment = $('#commentText').val();
    var parentId = $('#parent_id').val();
    console.log(parentId);
    if (comment !== "" && comment !== '') {
        $.get('/add-audio-comment', {
            ...
            if (res === "no-staff") {
                ...
                Swal.fire({
                    icon: 'error',
                    text: 'تعداد کامنت های ارسالی در 5 دقیقه اخیر برای شما بیش از 3 عدد بوده است. لطفا دقایقی دیگر مجددا تلاش کنید.',
