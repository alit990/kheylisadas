...
class Ch:
    def __init__(self, title=None, name=None, start_time=None, end_time=None):
        self.d = {}
...
class Au:
    ...
    def __init__(self, id=None, title=None, name=None, description=None, image_url=None, audio_url=None, is_lock=None,
                 type=None, like_count=None, dislike_count=None, fake_like_count=None, fake_dislike_count=None,
                 user_vote=None, added_playlist=None,
                 model=None, model_id=None, url=None):
        self.d = {}
        if id is not None:
            self.d["id"] = id
        if title is not None:
